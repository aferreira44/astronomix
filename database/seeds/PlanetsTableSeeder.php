...
class PlanetsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('planets')->insert([
            'name' => 'Earth',
            'mean_radius' => 6371, // km
            'mean_radius_unit_id' => 1,
            'equatorial_radius' => 6378.1370, // km
            'equatorial_radius_unit_id' => 1,
            'polar_radius' => 6356.7523, // km
            'polar_radius_unit_id' => 1,
            'equatorial_circumference' => 40075, // km
            'equatorial_circumference_unit_id' => 1,
            'meridional_circumference' => 40009,
            'meridional_circumference_unit_id' => 1,
            ...
            'orbital_period_unit_id' => 1,
            'rotation_period' => 0.99726968, // days
            'rotation_period_unit_id' => 1,
            'rings' => false,
            'atmosphere' => 'N2 O2 Ar',
